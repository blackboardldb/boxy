...
const CENTER_EMAIL = "mpfbup+centro1@gmail.com";
const STUDENT_EMAIL = "alumno+centro1@gmail.com";
const CENTER_NAME = "Centro 1";
...
async function main() {
  ...
  if (!adminUser) {
    ...
    await prisma.user.update({
      ...
      data: { authId: adminAuthId, phone: PHONE }
    });
  }
  ...
  if (!studentUser) {
    ...
    await prisma.user.update({
      ...
      data: { authId: studentAuthId, phone: PHONE }
    });
  }
