  ...
  return (
    <div className="p-4 md:p-8 space-y-4 max-w-4xl mx-auto flex flex-col min-h-screen">
      <div className=" space-y-4">
        <Button variant="ghost" size="icon" onClick={() => router.push(`/hub/alumnos/${student.id}`)} className="shrink-0 bg-zinc-100 rounded-full">
        ...
        <div>        
          ...
          <form onSubmit={handleSubmit} className="space-y-8 mt-8">
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end pt-2 gap-3">
              <Button type="button" variant="outline" className="w-full sm:w-auto h-11 rounded-xl" onClick={() => router.push(`/hub/alumnos/${student.id}`)}>
                Cancelar Operación
              </Button>
              <Button 
                type="submit" 
