  ...
  return (
    <div className="p-4 md:p-8 space-y-6 max-w-7xl mx-auto flex flex-col min-h-screen">
      <div className=" space-y-4">
        <Button variant="ghost" size="icon" onClick={() => router.push("/hub/alumnos")} className="shrink-0 bg-zinc-100 rounded-full">
                  ...
                  <div className="mt-6 pt-4 border-t border-zinc-100 flex flex-col gap-3">
                    {isPendingApproval && (
                      <Button 
                        ...
                        onClick={() => router.push('/hub/alertas')}
                      >
                    ...
                    <Button 
                      ...
                      onClick={() => router.push(`/hub/alumnos/${student.id}/nuevo-plan`)}
                    >
                ...
                <CardContent className="space-y-4 pt-4">
                  ...
                  <div className="flex items-center gap-2 mt-4">
                    <Checkbox
                      ...
                      onCheckedChange={(v) => setRegistrarIngreso(v as boolean)}
                    />
                    <Label htmlFor="registrarIngreso" className="text-sm text-zinc-600 cursor-pointer">
