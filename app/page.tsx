...
export default function Page() {
  return (
    <main className="min-h-screen bg-black grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="text-white p-4 flex items-center justify-center">
         <Logo size={240} />
      </div>
      <div className="p-8 mt-6  sm:m-6 rounded-xl bg-zinc-900 text-white space-y-3 flex flex-col items-end justify-end">
 ...
 <footer className="flex justify-center gap-4 mt-8 w-full">
          <Link
            href={"https://www.instagram.com/black.sheep.la/"}
            className=" p-2"
            target="_blank"
          >
            <svg
              ...
              viewBox="0 0 256 256"
              className="text-white hover:text-gray-300 transition-colors size-6"
            >
              <path
                fill="currentColor"
