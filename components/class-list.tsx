  ...
  if (isLoading && (!classes || classes.length === 0)) {
    return (
      <div className={`${className}`}>
        ...
        {/* Skeleton loaders */}
        <div role="status" className="text-center py-16 border border-zinc-700 rounded-lg flex item-center justify-center">
    <svg aria-hidden="true" className="inline w-14 h-14 w-12 h-12 text-zinc-700 animate-spin fill-lime-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
