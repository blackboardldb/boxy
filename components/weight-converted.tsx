      ...
      <Card className="bg-white">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="input-from" className="sr-only">
              Cantidad
            </Label>
            <div className="flex items-center gap-1">
              <Input
                ...
                placeholder="0"
                className="text-center text-2xl md:text-2xl font-bold flex-1 p-2"
                min="0"
                step="0.1"
              />
              <div className="px-3 py-3 bg-zinc-100 border rounded-md font-medium min-w-[50px] text-center">
                {fromUnit}
              </div>
            </div>
          </div>
          ...
          {/* Input destino */}
          <div className="space-y-2">
            <Label htmlFor="input-to" className="sr-only">
              Convertido a
            </Label>
            <div className="flex items-center gap-1">
              <Input
                ...
                placeholder="0"
                className="text-center text-2xl md:text-2xl font-bold flex-1 bg-muted p-2"
                disabled
                readOnly
              />
              <div className="px-3 py-3 bg-zinc-100 border rounded-md font-medium min-w-[50px] text-center">
